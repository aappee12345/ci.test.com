                ...
                <div class="col-xs-12">
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        <tr>
                            ...
                            <th class="left" width="200">所属分类</th>
                    ...
                    <div class="clear">
                        ...
                        <a href="<?php echo site_url(array('link','add',$this->uri->segment(3))); ?>" class="btn-success btn" style="float:left;margin:20px 10px;padding:0;">添加友情链接</a>
                        <input type="hidden" name="l_class" value="<?php echo $this->uri->segment(3);?>">
