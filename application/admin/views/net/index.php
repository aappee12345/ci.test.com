			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" id="netform" role="form" action="" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="key"> 授权码 </label>
										<div class="col-sm-11">
											<input type="text" name="key" id="key" placeholder="不填写此项网站无法打开" value="<?php echo set_value('key')?set_value('key'):$net['key']; ?>" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="form-group">
