							...
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="<?php echo site_url('/article/update'); ?>" method="post" enctype="multipart/form-data">
									...
									<div class="form-group form-group1">
										...
										<div class="col-sm-11">
											<!-- <script type="text/javascript" src="http://tp5.test.com/public/static/js/layer/layer.js"></script> -->
											<link rel="stylesheet" href="<?php echo base_url();?>css/layer1.js">
											<script type="text/javascript" src="<?php echo base_url();?>js/layer.js"></script>

											<style>
												.form-group1 {vertical-align: top;  position: relative; z-index: 1; }
												.form-group1 span.show { width: 22px; height: 22px; text-align: center; padding: 2px; position: absolute; z-index: 2; top: 0; left: 12px; }
												.form-group1 input{text-indent: 20px;}
												.form-group1 span.show a { color: #AAA; display: block; width: 22px; height: 22px; }
												.form-group1:hover span.show a,
												.form-group1 span.show a:hover { color: #2CBCA3; text-decoration: none; }
												.form-group1 span.show i { font-size: 14px; line-height: 22px; display: block; }
												.form-group1 span.show img { max-width: 22px; max-height: 22px; }
											</style>
											<span class="show">
					                            <a id="img_a" target="_blank" class="nyroModal" rel="gal" href="<?php echo strstr($article['a_index_pic'],'/upload');?>">
					                              <i id="img_i" class="fa fa-picture-o" onmouseover="layer.tips('<img src=<?php echo strstr($article['a_index_pic'],'/upload');?>>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"></i>
					                            </a>
					                        </span>
									...
									<div class="form-group form-group1">
										...
										<div class="col-sm-11">
											<span class="show">
					                            <a id="img_a" target="_blank" class="nyroModal" rel="gal" href="<?php echo strstr($article['a_pic'],'/upload');?>">
					                              <i id="img_i" class="fa fa-picture-o" onmouseover="layer.tips('<img src=<?php echo strstr($article['a_pic'],'/upload');?>>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"></i>
					                            </a>
					                        </span>
									...
									<div class="form-group">
										...
										<div class="col-sm-11">
											...
											<textarea rows="7" name="a_content" id="a_content" placeholder="此处选填" class="form-control1 col-xs-12 col-sm-6"><?php  echo set_value('a_content')?set_value('a_content'):$article['a_content']; ?></textarea>
										</div>
									</div>
									<div class="row">
...
<script>
	$('#created_at').datetimepicker({value:'<?php echo date("Y-m-d H:i:s",$article["created_at"]);?>', format: "Y-m-d H:i:s"});
	$('#updated_at').datetimepicker({value:'<?php echo date("Y-m-d H:i:s",$article["updated_at"]);?>', format: "Y-m-d H:i:s"});
</script>
