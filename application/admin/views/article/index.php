			...
			<div class="row">
				<div class="col-xs-12">
					<table id="sample-table-1" class="table table-striped table-bordered table-hover">
						...
						<tr>
							...
							<td>
								...
								<a class="red pull-left" title="删除文章" href="<?php echo site_url(array('article','delArticle',$article['a_id'])); ?>"><i class="ace-icon fa fa-trash-o bigger-120" style="margin:0px 0px 0px 5px;"></i></a>
						</tr>
						<?php endforeach;?>
					...
					<div class="clear">
						...
						<a href="<?php echo site_url(array('Article','add',$this->uri->segment(3)?$this->uri->segment(3):0)); ?>" class="btn-success btn" style="float:left;margin:20px 10px;padding:0;">添加文章</a>
