			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="<?php echo site_url('/article/add'); ?>" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-11">
											<input type="text" name="a_fulltitle" id="a_fulltitle" placeholder="必填" value="<?php echo set_value('a_fulltitle'); ?>" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="a_title"> 文章副标题 </label>
										<div class="col-sm-11">
											<input type="text" name="a_title" id="a_title" placeholder="此处选填" value="<?php echo set_value('a_title'); ?>" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="a_link"> 文章外链 </label>
										<div class="col-sm-11">
											<input type="text" name="a_link" id="a_link" placeholder="此处选填" value="<?php echo set_value('a_link'); ?>" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="a_keys"> 文章关键字 </label>
										<div class="col-sm-11">
											<textarea name="a_keys" style="width:66.666%;height:28px;padding-left:4px;" placeholder="文章关键字以英文逗号分隔" class="form-control1 col-xs-10 col-sm-5"><?php  echo set_value('a_keys'); ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="a_description"> 文章描述 </label>
										<div class="col-sm-11">
											<textarea name="a_description" style="width:66.666%;height:56px;padding-left:4px;" placeholder="此处选填" class="form-control1 col-xs-10 col-sm-5"><?php  echo set_value('a_description'); ?></textarea>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="a_index_pic"> 首页缩略图片 </label>
										<div class="col-sm-11">
											
					                    	
											<input type="text" name="a_index_file" class="col-xs-10 col-sm-5 pull-left inline" placeholder="图片地址" value="">
											<a href="javascript:;" class="file1 pull-left inline" style="margin-left:5px;margin-top:2px;">选择文件
												<input type="file" name="a_index_pic" id="a_index_pic">
											</a>
											<div class="showFileName1 pull-left inline" style="line-height:28px;text-indent:10px;"></div>
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="a_pic"> 缩略图片 </label>
										<div class="col-sm-11">
											<input type="text" name="a_file" class="col-xs-10 col-sm-5 pull-left inline" placeholder="图片地址" value="">
											<a href="javascript:;" class="file2 pull-left inline" style="margin-left:5px;margin-top:2px;">选择文件
												<input type="file" name="a_pic" id="a_pic">
											</a>
											...
											<span id="s" style="font-size:12px;line-height:28px;">
												<label>
													<input name="a_is_getimg" type="checkbox" class="ace" value="1">
													<span class="lbl"> </span>
												</label>&nbsp;&nbsp;文章内容是否调用缩略图片
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-11">
											<input type="text" name="created_at" id="created_at" placeholder="必填" value="<?php  echo set_value('created_at'); ?>" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="updated_at"> 修改时间 </label>
										<div class="col-sm-11">
											<input type="text" name="updated_at" id="updated_at" placeholder="必填" value="<?php echo set_value('updated_at'); ?>" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="a_click"> 阅读次数 </label>
										<div class="col-sm-11">
											<input type="text" name="a_click" id="a_click" placeholder="必填" value="<?php  echo set_value('a_click')?set_value('a_click'):1; ?>" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="a_source"> 文章来源 </label>
										<div class="col-sm-11">
											<input type="text" name="a_source" id="a_source" placeholder="必填" value="<?php  echo set_value('a_source')?set_value('a_source'):'本站'; ?>" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="a_author"> 文章作者 </label>
										<div class="col-sm-11">
											<input type="text" name="a_author" id="a_author" placeholder="必填" value="<?php  echo set_value('a_author')?set_value('a_author'):'master'; ?>" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="a_sort"> 排序号 </label>
										<div class="col-sm-11">
											<input type="text" name="a_sort" id="a_sort" placeholder="必填" value="<?php  echo set_value('a_sort')?set_value('a_sort'):50; ?>" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="a_profile"> 文章摘要 </label>
										<div class="col-sm-11">
											<textarea rows="7" name="a_profile" placeholder="此处选填" style="padding-left:4px;" class="form-control1 col-xs-10 col-sm-5"><?php  echo set_value('a_profile'); ?></textarea>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-11">
											...
											<textarea rows="7" name="a_content" id="a_content" placeholder="此处选填" class="form-control1 col-xs-12 col-sm-6"><?php  echo set_value('a_content'); ?></textarea>
										</div>
									</div>
									<div class="row">
