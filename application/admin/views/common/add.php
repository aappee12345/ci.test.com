...
<div class="main-content">
	...
	<div class="page-content">
		...
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo site_url('/common/add'); ?>" method="post" enctype="multipart/form-data">
					    ...
					    <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="co_title" id="co_title" placeholder="必填" value="<?php echo set_value('co_title'); ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="co_file" class="col-xs-10 col-sm-5 pull-left inline" placeholder="图片地址" value="">
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<textarea rows="3" name="co_description" id="co_description" style="width:700px;height:250px;" placeholder="此处选填" ><?php  echo set_value('co_description'); ?></textarea>
	                		</div>
						</div>
						<div class="form-group">
							<label class="col-sm-1 control-label no-padding-right" for="co_content"> 内容 </label>
							<div class="col-sm-11">
								<textarea rows="3" name="co_content" id="co_content" class="col-xs-12 col-sm-6" placeholder="此处选填" ><?php  echo set_value('co_content'); ?></textarea>
	                		</div>
						</div>
			            <div class="row">
