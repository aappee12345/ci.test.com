...
<div class="main-content">
	...
	<div class="page-content">
		...
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo site_url('/linktype/add'); ?>" method="post" enctype="multipart/form-data">
					    ...
					    <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="lt_name" id="lt_name" placeholder="友情链接分类名称，此处必填" value="<?php  echo set_value('lt_name'); ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
				        <div class="form-group" style="margin-bottom:0;">
					    	<div class="col-sm-1">
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="lt_width" id="lt_width" placeholder="友情链接图片宽度，此处选填" value="<?php  echo set_value('lt_width'); ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group" style="margin-bottom:0;">
					    	<div class="col-sm-1">
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="lt_height" id="lt_height" placeholder="友情链接图片高度，此处选填" value="<?php  echo set_value('lt_height'); ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
			            <div class="row">
