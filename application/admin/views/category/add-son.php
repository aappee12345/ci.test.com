							...
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-11">
											<input type="text" name="c_biaoshi" id="c_biaoshi" placeholder="标识栏目在首页所处位置，不可随意更改，自上而下1~9" value="<?php echo set_value('c_biaoshi'); ?>" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-11">
											<input type="text" class="col-xs-10 col-sm-5" name="c_title" id="c_title" value="<?php  echo set_value('c_title'); ?>" placeholder="此处选填">
	                					</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="c_keys"> 栏目关键字 </label>
										<div class="col-sm-11">
											<textarea rows="3" name="c_keys" placeholder="此处选填" style="width:66.66%;height:28px;" class="form-control1 control2"><?php  echo set_value('c_keys'); ?></textarea>
	                					</div>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="c_description"> 栏目描述 </label>
										<div class="col-sm-11">
											<textarea rows="3" name="c_description" placeholder="此处选填" style="width:66.66%;height:56px;" class="form-control1 control2"><?php  echo set_value('c_description'); ?></textarea>
	                					</div>
									</div>
									<div class="form-group">
									...
									<div class="row">
							            <div class="col-sm-8 col-sm-offset-1">
							                <input class="btn btn-info" type="submit" value="保&nbsp;&nbsp;存"/>
							            </div>
							        </div>
								</form>
							</div>
...
<script>
	...
	function selectchange(index,cid,ctext){
		...
		{
			$.ajax({    
		    	url:"/admin.php/category/ajaxson", 
		    	data:{cid:cid},
		    	type:'POST',    
		    	dataType:'JSON',    
		    	success:function(data) {    
		    		if (data[0])
		    		{
						...
						selectchange(index,data[0].c_id);
						return;
		    		}
		    		else
		    		{
