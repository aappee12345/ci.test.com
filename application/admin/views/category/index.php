				...
				<div class="col-xs-12">
					<table id="sample-table-1" class="table table-striped table-bordered table-hover">
						<tr>
							...
							<th width="120" class="left">导航状态</th>
							<th width="80" class="left">栏目标识</th>
						...
						<tr>
							...
							<td class="left">
								<?php if ($cate['c_is_nav']==0):?>
									不显示
								<?php elseif ($cate['c_is_nav']==1):?>
									仅在头部显示
								<?php elseif ($cate['c_is_nav']==2):?>
									仅在尾部显示
								<?php elseif ($cate['c_is_nav']==3):?>
									头部尾部都显示
								<?php endif;?>
							</td>
							<td class="left"><?php echo $cate['c_biaoshi']; ?></td>
