...
<div class="main-content">
	...
	<div class="page-content">
		...
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo site_url(array('Area','update')); ?>" method="post" enctype="multipart/form-data">
					    ...
					    <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="area_name" id="area_name" placeholder="必填" value="<?php echo set_value('area_name')?set_value('area_name'):$area['area_name']; ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="area_pinyin" id="area_pinyin" readonly value="<?php echo $area['area_pinyin']; ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
					    ...
					    <div class="form-group">
							...
							<div class="col-sm-11">
								<select name="area_pid" id="parentID1" class="parent form-control1" style="width:auto;margin-right:10px;">
				                	...
				                	<?php endif; ?>
			                        <?php foreach ($topareas as $val): ?>
			                        	<?php if ($val['area_id']==$area['area_pid']): ?>
											<option value="<?php echo $val['area_id']; ?>" <?php echo  set_select('area_id', $val['area_id'], TRUE); ?>><?php echo $val['area_name'];?></option>
				                        <?php else: ?>
											<option value="<?php echo $val['area_id']; ?>" <?php echo  set_select('area_id', $val['area_id']); ?>><?php echo $val['area_name'];?></option>
				                    	<?php endif; ?>
			                        <?php endforeach; ?>
			                    </select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-1">
								<input type="text" name="area_sort" id="area_sort" value="<?php echo set_value('area_sort')?set_value('area_sort'):$area['area_sort']; ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
			            <div class="row">
