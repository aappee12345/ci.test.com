...
<div class="main-content">
	...
	<div class="page-content">
		...
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo site_url('/link/update'); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="col-sm-11">
								<select name="l_class" id="parentID1" class="form-control1">
			                        <?php foreach ($linktypelist as $linktype):?>
			                        	<?php if ($linktype['lt_id']==$link['l_class']):?>
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="l_wzname" id="l_wzname" placeholder="友情链接名称，此处必填" value="<?php  echo set_value('l_wzname')?set_value('l_wzname'):$link['l_wzname']; ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<label>
									<?php if ($link['l_leixing']==2): ?>
									<input name="l_leixing" type="radio" class="ace" <?php echo set_radio('l_leixing', 2,true); ?> value="2">
									<?php else: ?>
									<input name="l_leixing" type="radio" class="ace" <?php echo set_radio('l_leixing', 2); ?> value="2">
									<?php endif; ?>
									<span class="lbl"> 文字链接</span>
								</label>
								<label>
									<?php if ($link['l_leixing']==1): ?>
									<input name="l_leixing" type="radio" class="ace" <?php echo set_radio('l_leixing', 1,true); ?> value="1">
									<?php else: ?>
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="l_file" class="col-xs-10 col-sm-5 pull-left inline" placeholder="图片地址" value="<?php echo $link['l_wzlogourl'];?>">
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="l_wzurl" id="l_wzurl" placeholder="链接地址，此处必填" value="<?php  echo set_value('l_wzurl')?set_value('l_wzurl'):$link['l_wzurl']; ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-group" style="margin-bottom:0;">
					    	<div class="col-sm-1">
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="l_sort" id="l_sort" placeholder="排序号，此处必填" value="<?php  echo set_value('l_sort')?set_value('l_sort'):$link['l_sort']; ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
			            <div class="row">
			                <div class="col-sm-8  col-sm-offset-1">
			                    <input type="submit" name="submit" class="btn btn-sm btn-success warning_3" value="保存"/>
			                    <!-- <input type="hidden" name="l_class" value="<?php echo $link['l_class'];?>"/> -->
	                    		<input type="hidden" name="l_id" value="<?php echo $link['l_id'];?>"/>
