				...
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo site_url('/common/update'); ?>" method="post" enctype="multipart/form-data">
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="co_file" class="col-xs-10 col-sm-5 pull-left inline" placeholder="图片地址" value="<?php echo $common['co_pic'];?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-11">
								<textarea rows="3" name="co_content" id="co_content" placeholder="此处选填" ><?php  echo set_value('co_content')?set_value('co_content'):$common['co_content']; ?></textarea>
	                		</div>
						</div>
			            <div class="row">
