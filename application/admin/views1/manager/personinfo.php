...
<div class="main-content">
	...
	<div class="page-content">
		...
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo site_url('/manager/personinfo'); ?>" method="post" enctype="multipart/form-data">
					    ...
					    <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="ma_username" id="ma_username" placeholder="必填" value="<?php echo set_value('ma_username')?set_value('ma_username'):$personinfo['ma_username']; ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="password" name="ma_password" id="ma_password" placeholder="请输入密码" value="<?php echo $personinfo['ma_password'];?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="ma_email" id="ma_email" placeholder="请输入邮箱地址" value="<?php echo set_value('ma_email')?set_value('ma_email'):$personinfo['ma_email']; ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
						<!--
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<select name="ma_rid" id="parentID1" class="form-control1">
			                        <?php foreach ($rolelist as $key=>$role):?>
			                        	<?php if ($role['r_id']==$personinfo['ma_rid']):?>
					...
					-->
			            <div class="row">
			                ...
			                <div class="col-sm-8  col-sm-offset-1">
								...
								<input type="hidden" name="maid" value="<?php echo $personinfo['ma_id'];?>">
			                </div>
