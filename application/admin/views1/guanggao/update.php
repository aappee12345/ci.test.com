...
<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li>
				<a href="<?php echo site_url('/guanggao/index').'/'.$guanggao['g_ad_id']; ?>">广告管理</a>
			</li>
	...
	<div class="page-content">
		...
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo site_url('/guanggao/update'); ?>" method="post" enctype="multipart/form-data">
					    ...
					    <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="g_title" id="g_title" placeholder="广告名称，此处必填" value="<?php  echo set_value('g_title')?set_value('g_title'):$guanggao['g_title']; ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
				        <div class="form-group" style="margin-bottom:0;">
					    	<div class="col-sm-1">
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="g_link" id="g_link" placeholder="此项选填" value="<?php  echo set_value('g_link')?set_value('g_link'):$guanggao['g_link']; ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="g_file" class="col-xs-10 col-sm-5 pull-left inline" placeholder="图片地址" value="<?php echo strstr($guanggao['g_path'],'/upload/');?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-11">
								<input type="text" name="g_sort" id="g_sort" placeholder="排序号填写正整数" value="<?php  echo set_value('g_sort')?set_value('g_sort'):$guanggao['g_sort']; ?>" class="col-xs-10 col-sm-5">
							</div>
						</div>
			            <div class="row">
			                <div class="col-sm-8 col-sm-offset-1">
								...
								<input type="hidden" name="g_ad_id" value="<?php echo $guanggao['g_ad_id'];?>">
								<input type="hidden" name="g_id" value="<?php echo $guanggao['g_id'];?>">
			                </div>
